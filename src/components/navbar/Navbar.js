...
const Navbar = ({ toggle }) => {
  return (
    <nav className='flex justify-around items-center h-16 bg-white text-black relative shadow-sm font-mono' role='navigation'>
        <Link to='/' className='pl-4'>startup-tracker</Link>
        <NavSearchbar />
        ...
        <div className='md:block hidden'>
            ...
            <Link className='p-4 hover:underline' to='/dashboard'>Dashboard</Link>
            <Link className='p-4 hover:underline' to='/screening'>Screening</Link>
